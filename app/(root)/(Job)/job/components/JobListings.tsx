...
export default function JobListings() {
  ...
  const JobDetails = ({ job }: { job: Job }) => (
    <div className="relative mx-auto max-w-3xl">
      {showStickyApply && (
        <div className="bg-background/95 supports-[backdrop-filter]:bg-background/60 animate-in fade-in slide-in-from-top fixed inset-x-0 top-0 z-10 border-b p-4 backdrop-blur transition-all duration-200">
